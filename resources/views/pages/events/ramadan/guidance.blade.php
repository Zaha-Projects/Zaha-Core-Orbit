...
<div class="container py-4">
    <div class="card">
        <div class="card-header">
            ...
            <div class="text-muted">Version {{ $guidance->version_number }} · {{ optional($guidance->published_at)->format('Y-m-d') }}</div>
        </div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('events.ramadan.guidance.accept') }}">
                ...
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="accept_guidance">I have read and accept this guidance version.</label>
                </div>
