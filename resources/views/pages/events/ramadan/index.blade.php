...
<div class="container py-4">
    ...
    <div class="card"><div class="table-responsive"><table class="table table-hover mb-0">
        <thead><tr><th>ID</th><th>Title</th><th>Branch</th><th>Date</th><th>Relations officer</th><th>Planning</th><th>Execution</th><th>Attendance</th><th>Meals</th><th>Workflow</th></tr></thead>
        <tbody>@forelse($iftars as $iftar)<tr>
            ...
            <td><span class="badge bg-secondary">{{ $iftar->status }}</span></td><td><span class="badge bg-info text-dark">{{ $iftar->execution_status }}</span></td>
        ...
        </tr>@empty<tr><td colspan="10" class="text-center text-muted">No Ramadan Iftars are available.</td></tr>@endforelse</tbody>
