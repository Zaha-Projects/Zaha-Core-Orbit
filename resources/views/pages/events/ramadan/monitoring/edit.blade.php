@extends('layouts.app')
@section('content')
<div class="container py-4"><div class="d-flex justify-content-between"><h1 class="h3">Monitoring report #{{ $monitoringReport->id }}</h1><a href="{{ route('events.ramadan.iftars.show', $ramadanIftar) }}">Back to Iftar</a></div>
