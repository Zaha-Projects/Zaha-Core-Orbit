                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>
                                            {{ $user->branch?->name ?? __('app.roles.super_admin.users.table.unassigned') }} @if($user->branch?->is_main)<span class="badge bg-primary ms-1">رئيسي</span>@endif
                                        ...
                                        <td>{{ $user->branch?->name ?? __('app.roles.super_admin.users.table.unassigned') }} @if($user->branch?->is_main)<span class="badge bg-primary ms-1">رئيسي</span>@endif</td>
