        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('role.reports.kpis.store') }}" class="row g-3">
                    @csrf
                    <div class="col-12 col-md-2"><label class="form-label">{{ __('app.roles.reports.kpis.fields.year') }}</label><input class="form-control" type="number" name="year" value="{{ now()->year }}" ></div>
                    <div class="col-12 col-md-2"><label class="form-label">{{ __('app.roles.reports.kpis.fields.month') }}</label><input class="form-control" type="number" min="1" max="12" name="month" value="{{ now()->month }}" ></div>
                    ...
                    <div class="col-6 col-md-2"><label class="form-label">{{ __('app.roles.reports.kpis.fields.planned_activities_count') }}</label><input class="form-control" type="number" min="0" name="planned_activities_count" ></div>
                    <div class="col-6 col-md-2"><label class="form-label">{{ __('app.roles.reports.kpis.fields.unplanned_activities_count') }}</label><input class="form-control" type="number" min="0" name="unplanned_activities_count" ></div>
