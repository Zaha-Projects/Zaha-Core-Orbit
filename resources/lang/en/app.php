...
return [
    ...
    'roles' => [
        'super_admin' => [
            ...
            'actions' => [
                ...
                'step_created' => 'Workflow step created successfully.',
                'step_updated' => 'Workflow step updated successfully.',
                'step_deleted' => 'Workflow step deleted successfully.',
                'builder_title' => 'Workflow Builder / منشئ سير الاعتماد',
                'builder_subtitle' => 'Govern and maintain approval workflows safely.',
                'create_title' => 'Create Workflow / إنشاء سير اعتماد',
    ...
    'acl' => [
        ...
        'permissions' => [
            ...
            'agenda_delete' => 'Delete agenda',
            'monthly_plan_view' => 'View monthly plan',
            'monthly_plan_create' => 'Create monthly plan',
            'monthly_plan_edit' => 'Edit monthly plan',
            'monthly_plan_delete' => 'Delete monthly plan',
            'monthly_plan_approve' => 'Approve monthly plan',
            'evaluation_view' => 'View evaluation',
            'evaluation_submit' => 'Submit evaluation',
            'evaluation_manage' => 'Manage evaluation',
            'communications_view_media' => 'View media',
            'communications_upload_media' => 'Upload media',
            'branches_view_all' => 'View all branches',
            'branches_view_own' => 'View own branch only',
            'monthly_activities_view' => 'View monthly activities',
            'monthly_activities_view_other_branches' => 'View other branches monthly plans',
            'monthly_activities_create' => 'Create monthly activities',
            'monthly_activities_edit' => 'Edit monthly activities',
            'monthly_activities_delete' => 'Delete monthly activities',
            'monthly_activities_approve' => 'Approve monthly activities',
            'users_view' => 'View users',
            'users_manage' => 'Manage users',
            'roles_view' => 'View roles',
            'roles_manage' => 'Manage roles',
            'workflows_manage' => 'Manage workflows',
    ...
    'reports' => [
            ...
            'users' => [
                ...
                'fields' => [
                    ...
                    'assigned_branches_short' => 'Assigned',
                    'assigned_branches_help' => 'Shown only for Branch Coordinator. These branches define which monthly activities appear for this user in approvals.',
                    'assigned_branches_required' => 'Select at least one branch for the Branch Coordinator.',
                    'center' => 'Center',
                    'role' => 'Role',
                    'status' => 'Status',
                    'branch_placeholder' => 'Select branch',
        ...
        'relations' => [
            'agenda' => [
                ...
                'fields_ext' => [
                    'department' => 'Unit/Department',
                    'owner_department' => 'Owner unit/department',
                    'primary_department' => 'Primary unit/department',
                    'partner_department' => 'Partner units/departments',
                    'event_type' => 'Event type',
                    'plan_type' => 'Plan type',
                    'unified_plan_source' => 'Unified plan mode',
                    'agenda_plan_file' => 'Initial plan file (optional)',
                    'branch_participation' => 'Branch participation',
                ...
                'placeholders' => [
                    'owner_department' => 'Select owner unit/department',
                    'event_category' => 'Select category',
                ],
                'unified_plan_sources' => [
                    'monthly_auto' => 'Auto-add plan to monthly plans',
                    'upload_file' => 'Upload initial plan file',
                ],
                'hints' => [
                    'unified_plan_source' => 'These options appear only when plan type is Unified.',
                    'agenda_plan_file' => 'This file is linked to the unified plan when file upload is selected.',
                    'scope_notice' => 'The annual agenda shows all branch events, while monthly planning stays limited to the user\'s branch events.',
                ],
                'filters' => [
                ...
                'status_labels' => [
                    ...
                    'rejected' => 'Rejected',
                    'submitted' => 'Submitted',
                    'relations_approved' => 'Approved by relations manager',
                    'published' => 'Published',
                    'pending' => 'Pending',
                    'in_review' => 'In review',
                    'draft' => 'Draft',
            ...
            'monthly_activities' => [
                ...
                'approvals' => [
                    ...
                    'errors' => [
                        ...
                        'invalid_decision' => 'The selected decision is not valid.',
                        'decision_required' => 'Decision is required.',
                        'not_available_for_current_state' => 'Approval action is not available for current workflow state.',
                        'not_assigned_to_current_step' => 'You are not authorized for the current workflow step.',
                        'self_approval_forbidden' => 'Self-approval is not allowed.',
                        'resubmit_only_after_changes_requested' => 'Resubmission is only allowed after changes are requested.',
                        'no_active_workflow' => 'No active workflow found for this module.',
                        'note_required' => 'Note is required.',
                    ],
                    'notifications' => [
                        'title' => 'Workflow decision update',
                        'body' => 'Decision :decision was recorded at step :step.',
                        'submit_title' => 'Monthly activity submitted',
                        'submit_body' => 'Monthly activity ":activity" was submitted for approval.',
                    ],
