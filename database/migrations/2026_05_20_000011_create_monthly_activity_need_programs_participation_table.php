...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('monthly_activity_need_programs_participation', function (Blueprint $table) {
            ...
            $table->unique('monthly_activity_id', 'uq_man_000011_ma');
            $table->index('monthly_activity_id', 'idx_man_000011_ma');
            $table->index('is_required', 'idx_man_000011_req');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('monthly_activity_need_programs_participation');
    }
};
