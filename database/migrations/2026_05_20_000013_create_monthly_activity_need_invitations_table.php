...
return new class extends Migration {
    ...
    {
        Schema::create('monthly_activity_need_invitations', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('monthly_activity_id');
            $table->foreign('monthly_activity_id', 'fk_man_000013_ma')->references('id')->on('monthly_activities')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('monthly_activity_need_invitations');
    }
};
