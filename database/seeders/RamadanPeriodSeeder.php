...
class RamadanPeriodSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $initial = $legacy->isEmpty()
            ? ['year' => 2026, 'hijri_year' => 1447, 'start_date' => '2026-02-18', 'end_date' => '2026-03-19', 'is_active' => true]
            : ['year' => (int) $legacy['ramadan_period_year'], 'hijri_year' => null, 'start_date' => $legacy['ramadan_period_start_date'], 'end_date' => $legacy['ramadan_period_end_date'], 'is_active' => $legacy['ramadan_period_is_active'] === '1'];
