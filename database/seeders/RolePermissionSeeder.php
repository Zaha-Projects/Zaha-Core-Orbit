...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'transport_officer' => ['transport.view', 'transport.manage', 'movement.view', 'movement.manage'],
            'movement_manager' => ['movement.view', 'movement.manage'],
            'movement_editor' => ['movement.view', 'movement.manage'],
            'movement_viewer' => ['movement.view'],
