    ...
    private function rolePermissionMap(): array
    {
        return [
            ...
            'relations_manager' => [
                ...
                'kpi.view',
                'evaluation.view_all',
                'evaluation.forms.manage',
                'evaluation.questions.manage',
                'evaluation.visibility.manage',
                'post_execution.view_all',
            ],
            'supervisor' => [
                'agenda.view',
                'agenda.participation.update',
            ...
            'followup_officer' => [
                ...
                'evaluation.submit',
                'evaluation.view_branch',
                'evaluation.submit_branch',
                'post_execution.view_branch',
                'post_execution.verify_branch',
            ],
            'workshops_secretary' => [
                'agenda.view',
                'agenda.approve',
            ...
            'evaluation_officer' => ['agenda.view', 'monthly_activities.view', 'monthly_activities.view_other_branches', 'evaluation.view', 'evaluation.view_all', 'post_execution.view_all', 'branches.view.all'],
