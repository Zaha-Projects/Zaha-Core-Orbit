    ...
    private function workflowDefinitions(): array
    {
        return [
            ...
            [
                ...
                'steps' => [
                    [
                        'step_key' => 'monthly_relations_officer_submit',
                        'step_order' => 1,
                        'approval_level' => 1,
                        'name_ar' => 'إنشاء وإرسال مسؤول العلاقات',
                        'name_en' => 'Relations Officer Draft & Submit',
            ...
            [
                'code' => 'ramadan_iftar_change_request_approval',
                'module' => 'ramadan_iftar_change_requests',
                'name_ar' => 'سير اعتماد طلب تعديل خطة إفطار رمضان',
                'name_en' => 'Ramadan Iftar Change Request Approval',
                'steps' => [
                    ['step_key' => 'ramadan_change_supervisor_review', 'step_order' => 1, 'approval_level' => 1, 'name_ar' => 'مراجعة رئيس الفرع', 'name_en' => 'Supervisor Review', 'step_type' => 'main', 'role' => 'supervisor', 'is_editable' => false],
                    ['step_key' => 'ramadan_change_branch_coordinator_review', 'step_order' => 2, 'approval_level' => 2, 'name_ar' => 'مراجعة منسق الفروع', 'name_en' => 'Branch Coordinator Review', 'step_type' => 'main', 'role' => 'branch_coordinator', 'is_editable' => false],
                    ['step_key' => 'ramadan_change_relations_manager_review', 'step_order' => 3, 'approval_level' => 3, 'name_ar' => 'مراجعة مدير العلاقات الرئيسي', 'name_en' => 'Primary Relations Manager Review', 'step_type' => 'main', 'role' => 'relations_manager', 'is_editable' => false],
                    ['step_key' => 'ramadan_change_executive_manager_review', 'step_order' => 4, 'approval_level' => 4, 'name_ar' => 'الاعتماد النهائي من المدير التنفيذي', 'name_en' => 'Executive Manager Final Approval', 'step_type' => 'main', 'role' => 'executive_manager', 'is_editable' => false],
                ],
            ],
        ];
    }
