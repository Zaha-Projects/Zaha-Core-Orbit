...
class RamadanIftarMonitoringController extends Controller
{
    ...
    private function authorizeMonitoring(Request $request, RamadanIftar $iftar): void
    {
        $user = $request->user();
        ...
        abort_unless($iftar->status === RamadanIftar::STATUS_APPROVED && $iftar->execution_status === RamadanIftar::EXECUTION_STATUS_IN_PROGRESS, 403);
    }
}
