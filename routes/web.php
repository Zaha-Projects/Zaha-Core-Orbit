...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'index'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.index');
    ...
    Route::get('/dashboard/relations/monthly-activities/create', [ProgramsMonthlyActivitiesController::class, 'create'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.create');
    Route::post('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'store'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.store');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.edit');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.update');
