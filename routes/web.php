...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'index'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.view|monthly_plan.view')->middleware('branch.isolation')->name('role.relations.activities.index');
    ...
    Route::get('/dashboard/relations/monthly-activities/create', [ProgramsMonthlyActivitiesController::class, 'create'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.create|monthly_plan.create')->middleware('branch.isolation')->name('role.relations.activities.create');
    Route::post('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'store'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.create|monthly_plan.create')->middleware('branch.isolation')->name('role.relations.activities.store');
