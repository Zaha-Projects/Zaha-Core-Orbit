...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/agenda/{agendaEvent}/edit', [RelationsAgendaEventsController::class, 'edit'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|agenda.update')->name('role.relations.agenda.edit');
    Route::put('/dashboard/relations/agenda/{agendaEvent}', [RelationsAgendaEventsController::class, 'update'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|agenda.update')->name('role.relations.agenda.update');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/submit', [RelationsAgendaEventsController::class, 'submit'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|agenda.update')->name('role.relations.agenda.submit');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/unit-participation', [RelationsAgendaEventsController::class, 'updateUnitParticipation'])->middleware('role_or_permission:relations_manager|workshops_secretary|communication_head|programs_manager|super_admin|agenda.participation.update')->name('role.relations.agenda.unit_participation.update');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/branch-participation', [RelationsAgendaEventsController::class, 'updateBranchParticipation'])->middleware('role_or_permission:relations_officer|branch_relations_officer|super_admin|agenda.participation.update')->name('role.relations.agenda.branch_participation.update');
