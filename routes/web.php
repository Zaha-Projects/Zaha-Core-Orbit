...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/dashboard/admin/events-lookups/departments/{department}/visual', [EventLookupsController::class, 'updateDepartmentVisual'])->middleware('role:super_admin')->name('role.super_admin.events_lookups.departments.visual.update');
    Route::put('/dashboard/admin/events-lookups/department-units/{departmentUnit}/visual', [EventLookupsController::class, 'updateUnitVisual'])->middleware('role:super_admin')->name('role.super_admin.events_lookups.department_units.visual.update');
    ...
    Route::get('/dashboard/relations/agenda/{agendaEvent}', [RelationsAgendaEventsController::class, 'show'])->middleware('role_or_permission:relations_manager|relations_officer|executive_manager|super_admin|agenda.view')->middleware('branch.isolation')->name('role.relations.agenda.show');
