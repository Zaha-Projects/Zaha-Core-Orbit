...
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivitiesBrowseController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityCalendarController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityFeedbackController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityLifecycleController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityPlanningController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityReportsController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityTrashController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityWorkspaceController;
...
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityApprovalDecisionController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityApprovalQueueController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityChangeRequestDecisionController;
use App\Modules\Events\Http\Controllers\MonthlyActivities\MonthlyActivityPostExecutionDecisionController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/admin/monthly-activities/change-requests/reports', [MonthlyActivityReportsController::class, 'changeRequestReports'])->middleware('role:super_admin|admin')->name('role.super_admin.monthly_activities.change_requests.reports');
    ...
    Route::post('/dashboard/admin/events-lookups/zaha-time-options', [EventLookupsController::class, 'storeZahaTimeOption'])->middleware('role:super_admin')->name('role.super_admin.events_lookups.zaha_time_options.store');
    Route::put('/dashboard/admin/events-lookups/zaha-time-options/{zahaTimeOption}', [EventLookupsController::class, 'updateZahaTimeOption'])->middleware('role:super_admin')->name('role.super_admin.events_lookups.zaha_time_options.update');
    ...
    Route::get('/dashboard/relations/agenda', [RelationsAgendaEventsController::class, 'index'])->middleware('role_or_permission:relations_manager|relations_officer|executive_manager|programs_manager|super_admin|agenda.view')->middleware('branch.isolation')->name('role.relations.agenda.index');
    ...
    Route::delete('/dashboard/relations/agenda/{agendaEvent}', [RelationsAgendaEventsController::class, 'destroy'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|agenda.delete')->whereNumber('agendaEvent')->name('role.relations.agenda.destroy');
    ...
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/unit-participation', [RelationsAgendaEventsController::class, 'updateUnitParticipation'])->middleware('role_or_permission:relations_manager|workshops_secretary|communication_head|super_admin|agenda.participation.update')->whereNumber('agendaEvent')->name('role.relations.agenda.unit_participation.update');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/branch-participation', [RelationsAgendaEventsController::class, 'updateBranchParticipation'])->middleware('role_or_permission:relations_officer|super_admin|agenda.participation.update')->whereNumber('agendaEvent')->name('role.relations.agenda.branch_participation.update');
    Route::post('/dashboard/relations/agenda/{agendaEvent}/quick-subscribe', [RelationsAgendaEventsController::class, 'quickSubscribeBranchToPlan'])->middleware('role_or_permission:relations_officer|super_admin|agenda.participation.update')->whereNumber('agendaEvent')->name('role.relations.agenda.quick_subscribe');
    Route::get('/dashboard/relations/agenda/approvals', [RelationsAgendaApprovalsController::class, 'index'])->name('role.relations.approvals.index');
    Route::put('/dashboard/relations/agenda/approvals/{agendaEvent}', [RelationsAgendaApprovalsController::class, 'update'])->name('role.relations.approvals.update');
    Route::put('/dashboard/relations/agenda/approvals/delete-requests/{deleteRequest}', [RelationsAgendaApprovalsController::class, 'decideDeleteRequest'])->name('role.relations.approvals.delete_requests.update');
    Route::put('/dashboard/relations/agenda/approvals/edit-requests/{editRequest}', [RelationsAgendaApprovalsController::class, 'decideEditRequest'])->name('role.relations.approvals.edit_requests.update');
    ...
    Route::prefix('dashboard/events/ramadan/iftars')->name('events.ramadan.iftars.')->middleware('branch.isolation')->group(function () {
        ...
        Route::get('/{ramadanIftar}/change-request', [RamadanIftarChangeRequestController::class, 'create'])->middleware('permission:ramadan_iftars.change_request.create')->whereNumber('ramadanIftar')->name('change-request.create');
    ...
    Route::prefix('dashboard/events/ramadan/change-requests')->name('events.ramadan.change-requests.reviews.')->middleware(['branch.isolation', 'permission:ramadan_iftars.change_request.review'])->group(function () {
        Route::get('/', [RamadanIftarChangeRequestReviewController::class, 'index'])->name('index');
        Route::get('/{changeRequest}', [RamadanIftarChangeRequestReviewController::class, 'show'])->whereNumber('changeRequest')->name('show');
        Route::post('/{changeRequest}/decision', [RamadanIftarChangeRequestReviewController::class, 'decide'])->whereNumber('changeRequest')->name('decision');
    });
    ...
    Route::get('/dashboard/relations/monthly-activities/calendar', [MonthlyActivityCalendarController::class, 'calendar'])->middleware('role_or_permission:relations_manager|relations_officer|volunteer_coordinator|programs_manager|super_admin|monthly_activities.view')->middleware('branch.isolation')->name('role.relations.activities.calendar');
    Route::get('/dashboard/relations/monthly-activities/trash', [MonthlyActivityTrashController::class, 'trash'])->middleware('role_or_permission:relations_manager|relations_officer|supervisor|branch_coordinator|volunteer_coordinator|super_admin|monthly_activities.view')->middleware('branch.isolation')->name('role.relations.activities.trash');
    Route::get('/dashboard/relations/monthly-activities/returned-feedback', [MonthlyActivityFeedbackController::class, 'returnedFeedback'])->middleware('role:relations_manager|relations_officer|super_admin')->middleware('branch.isolation')->name('role.relations.activities.returned_feedback');
    Route::get('/dashboard/relations/monthly-activities/post-execution-feedback', [MonthlyActivityFeedbackController::class, 'postExecutionFeedback'])->middleware('role:volunteer_coordinator|super_admin')->middleware('branch.isolation')->name('role.relations.activities.post_execution_feedback');
    Route::patch('/dashboard/relations/monthly-activities/trash/{monthlyActivity}/restore', [MonthlyActivityTrashController::class, 'restore'])->middleware('role:super_admin|admin')->middleware('branch.isolation')->name('role.relations.activities.trash.restore');
    Route::post('/dashboard/relations/monthly-activities/sync-from-agenda', [MonthlyActivityPlanningController::class, 'syncFromAgenda'])->middleware('role:relations_manager|relations_officer|super_admin')->middleware('branch.isolation')->name('role.relations.activities.sync_from_agenda');
    Route::get('/dashboard/relations/monthly-activities/create', [MonthlyActivityPlanningController::class, 'create'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|monthly_activities.create')->middleware('branch.isolation')->name('role.relations.activities.create');
    Route::post('/dashboard/relations/monthly-activities', [MonthlyActivityPlanningController::class, 'store'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|monthly_activities.create')->middleware('branch.isolation')->name('role.relations.activities.store');
    Route::get('/dashboard/relations/monthly-activities/deleted/{monthlyActivity}', [MonthlyActivityWorkspaceController::class, 'showDeleted'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.deleted.show');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [MonthlyActivityPlanningController::class, 'edit'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.edit');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [MonthlyActivityWorkspaceController::class, 'show'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|programs_manager|super_admin')->name('role.relations.activities.show');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [MonthlyActivityPlanningController::class, 'update'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.update');
    Route::delete('/dashboard/relations/monthly-activities/{monthlyActivity}', [MonthlyActivityTrashController::class, 'destroy'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|super_admin')->name('role.relations.activities.destroy');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/submit', [MonthlyActivityLifecycleController::class, 'submit'])->middleware('role:relations_manager|relations_officer|supervisor|relations_officer|super_admin')->name('role.relations.activities.submit');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/close', [MonthlyActivityLifecycleController::class, 'close'])->middleware('role:relations_manager|relations_officer|supervisor|relations_officer|super_admin')->name('role.relations.activities.close');
    Route::post('/dashboard/programs/monthly-activities/{monthlyActivity}/supplies', [ProgramsMonthlyActivitySuppliesController::class, 'store'])->middleware('role:programs_officer')->name('role.programs.supplies.store');
    Route::put('/dashboard/programs/supplies/{monthlyActivitySupply}', [ProgramsMonthlyActivitySuppliesController::class, 'update'])->middleware('role:programs_officer')->name('role.programs.supplies.update');
    Route::delete('/dashboard/programs/supplies/{monthlyActivitySupply}', [ProgramsMonthlyActivitySuppliesController::class, 'destroy'])->middleware('role:programs_officer')->name('role.programs.supplies.destroy');
    Route::post('/dashboard/programs/monthly-activities/{monthlyActivity}/team', [ProgramsMonthlyActivityTeamController::class, 'store'])->middleware('role:programs_officer')->name('role.programs.team.store');
    Route::put('/dashboard/programs/team/{monthlyActivityTeam}', [ProgramsMonthlyActivityTeamController::class, 'update'])->middleware('role:programs_officer')->name('role.programs.team.update');
    Route::delete('/dashboard/programs/team/{monthlyActivityTeam}', [ProgramsMonthlyActivityTeamController::class, 'destroy'])->middleware('role:programs_officer')->name('role.programs.team.destroy');
    Route::post('/dashboard/programs/monthly-activities/{monthlyActivity}/attachments', [ProgramsMonthlyActivityAttachmentsController::class, 'store'])->middleware('role:programs_officer|relations_manager|relations_officer|super_admin')->name('role.programs.attachments.store');
    ...
    Route::delete('/dashboard/programs/attachments/{monthlyActivityAttachment}', [ProgramsMonthlyActivityAttachmentsController::class, 'destroy'])->middleware('role:programs_officer|relations_manager|relations_officer|super_admin')->name('role.programs.attachments.destroy');
    Route::get('/dashboard/programs/monthly-activities/approvals', [MonthlyActivityApprovalQueueController::class, 'index'])->name('role.programs.approvals.index');
    Route::patch('/dashboard/programs/monthly-activities/approvals/{monthlyActivity}/post-execution-decision', [MonthlyActivityPostExecutionDecisionController::class, 'decidePostExecution'])->name('role.programs.approvals.post_execution_decision');
    Route::get('/dashboard/programs/monthly-activities/approvals/{monthlyActivity}/details', [MonthlyActivityApprovalQueueController::class, 'details'])->name('role.programs.approvals.details');
    ...
    Route::put('/dashboard/programs/monthly-activities/approvals/{monthlyActivity}', [MonthlyActivityApprovalDecisionController::class, 'update'])->name('role.programs.approvals.update');
    Route::put('/dashboard/programs/monthly-activities/approvals/delete-requests/{deleteRequest}', [MonthlyActivityChangeRequestDecisionController::class, 'decideDeleteRequest'])->name('role.programs.approvals.delete_requests.update');
    Route::put('/dashboard/programs/monthly-activities/approvals/edit-requests/{editRequest}', [MonthlyActivityChangeRequestDecisionController::class, 'decideEditRequest'])->name('role.programs.approvals.edit_requests.update');
    Route::put('/dashboard/programs/monthly-activities/approvals/{monthlyActivity}/execution-need', [MonthlyActivityApprovalDecisionController::class, 'decideExecutionNeed'])->name('role.programs.approvals.execution_needs.update');
