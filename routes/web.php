...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/agenda', [RelationsAgendaEventsController::class, 'index'])->middleware('role_or_permission:relations_manager|relations_officer|executive_manager|super_admin|agenda.view')->name('role.relations.agenda.index');
    ...
    Route::put('/dashboard/relations/agenda/{agendaEvent}', [RelationsAgendaEventsController::class, 'update'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.agenda.update');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/submit', [RelationsAgendaEventsController::class, 'submit'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.agenda.submit');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/unit-participation', [RelationsAgendaEventsController::class, 'updateUnitParticipation'])->middleware('role:relations_manager|workshops_secretary|communication_head|programs_manager|super_admin')->name('role.relations.agenda.unit_participation.update');
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/branch-participation', [RelationsAgendaEventsController::class, 'updateBranchParticipation'])->middleware('role:relations_officer|branch_relations_officer|super_admin')->name('role.relations.agenda.branch_participation.update');
    Route::get('/dashboard/relations/agenda/approvals', [RelationsAgendaApprovalsController::class, 'index'])->middleware('role:relations_manager|executive_manager|super_admin')->name('role.relations.approvals.index');
    Route::put('/dashboard/relations/agenda/approvals/{agendaEvent}', [RelationsAgendaApprovalsController::class, 'update'])->middleware('role:relations_manager|executive_manager|super_admin')->name('role.relations.approvals.update');
    ...
    Route::get('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'index'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.view|monthly_plan.view')->name('role.relations.activities.index');
    ...
    Route::post('/dashboard/relations/monthly-activities/sync-from-agenda', [ProgramsMonthlyActivitiesController::class, 'syncFromAgenda'])->middleware('role:relations_manager|relations_officer|branch_relations_officer|super_admin')->name('role.relations.activities.sync_from_agenda');
    Route::get('/dashboard/relations/monthly-activities/create', [ProgramsMonthlyActivitiesController::class, 'create'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.create|monthly_plan.create')->name('role.relations.activities.create');
    Route::post('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'store'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.create|monthly_plan.create')->name('role.relations.activities.store');
    ...
    Route::get('/dashboard/programs/monthly-activities/approvals', [ProgramsMonthlyActivityApprovalsController::class, 'index'])->middleware('role_or_permission:relations_officer|relations_manager|programs_officer|programs_manager|executive_manager|monthly_activities.approve|monthly_plan.approve')->name('role.programs.approvals.index');
    ...
    Route::put('/dashboard/programs/monthly-activities/approvals/{monthlyActivity}', [ProgramsMonthlyActivityApprovalsController::class, 'update'])->middleware('role_or_permission:relations_officer|relations_manager|programs_officer|programs_manager|executive_manager|monthly_activities.approve|monthly_plan.approve')->name('role.programs.approvals.update');
    ...
    Route::get('/dashboard/reports/overview', [ReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.index');
    Route::post('/dashboard/reports/overview/export', [ReportsController::class, 'export'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.export');
    Route::get('/dashboard/reports/agenda', [AgendaReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.agenda.index');
    Route::post('/dashboard/reports/agenda/export', [AgendaReportsController::class, 'export'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.agenda.export');
    Route::get('/dashboard/reports/monthly', [MonthlyReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.monthly.index');
    Route::post('/dashboard/reports/monthly/export', [MonthlyReportsController::class, 'export'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.monthly.export');
    Route::get('/dashboard/reports/finance', [FinanceReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.finance.index');
    Route::post('/dashboard/reports/finance/export', [FinanceReportsController::class, 'export'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.finance.export');
    Route::get('/dashboard/reports/maintenance', [MaintenanceReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.maintenance.index');
    Route::post('/dashboard/reports/maintenance/export', [MaintenanceReportsController::class, 'export'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.maintenance.export');
    Route::get('/dashboard/reports/transport', [TransportReportsController::class, 'index'])->middleware('role:reports_viewer|followup_officer')->name('role.reports.transport.index');
