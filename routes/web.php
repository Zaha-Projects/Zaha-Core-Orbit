...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'store'])->middleware('role_or_permission:relations_manager|relations_officer|super_admin|monthly_activities.create')->middleware('branch.isolation')->name('role.relations.activities.store');
    Route::get('/dashboard/relations/monthly-activities/deleted/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'showDeleted'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.deleted.show');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.edit');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|programs_manager|super_admin')->name('role.relations.activities.show');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.update');
    Route::delete('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'destroy'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|super_admin')->name('role.relations.activities.destroy');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/submit', [ProgramsMonthlyActivitiesController::class, 'submit'])->middleware('role:relations_manager|relations_officer|supervisor|relations_officer|super_admin')->name('role.relations.activities.submit');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/close', [ProgramsMonthlyActivitiesController::class, 'close'])->middleware('role:relations_manager|relations_officer|supervisor|relations_officer|super_admin')->name('role.relations.activities.close');
