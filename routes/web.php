...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities/calendar', [ProgramsMonthlyActivitiesController::class, 'calendar'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|super_admin|monthly_activities.view')->middleware('branch.isolation')->name('role.relations.activities.calendar');
