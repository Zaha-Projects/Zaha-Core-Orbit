...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'index'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.index');
    Route::post('/dashboard/relations/monthly-activities/sync-from-agenda', [ProgramsMonthlyActivitiesController::class, 'syncFromAgenda'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.sync_from_agenda');
    Route::get('/dashboard/relations/monthly-activities/create', [ProgramsMonthlyActivitiesController::class, 'create'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.create');
    Route::post('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'store'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.store');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.edit');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.update');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/submit', [ProgramsMonthlyActivitiesController::class, 'submit'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.submit');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/close', [ProgramsMonthlyActivitiesController::class, 'close'])->middleware('role:relations_manager|relations_officer|super_admin')->name('role.relations.activities.close');
