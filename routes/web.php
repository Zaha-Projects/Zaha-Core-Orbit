...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.edit');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.show');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_coordinator|followup_officer|evaluation_officer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.update');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/submit', [ProgramsMonthlyActivitiesController::class, 'submit'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|relations_officer|super_admin')->name('role.relations.activities.submit');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/close', [ProgramsMonthlyActivitiesController::class, 'close'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|relations_officer|super_admin')->name('role.relations.activities.close');
    ...
    Route::get('/dashboard/programs/attachments/{monthlyActivityAttachment}/download', [ProgramsMonthlyActivityAttachmentsController::class, 'download'])->middleware('role:programs_manager|programs_officer|relations_manager|relations_officer|branch_relations_manager|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.programs.attachments.download');
