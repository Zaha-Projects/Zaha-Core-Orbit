...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/dashboard/relations/agenda/{agendaEvent}/unit-participation', [RelationsAgendaEventsController::class, 'updateUnitParticipation'])->middleware('role:relations_manager|workshops_secretary|communication_head|programs_manager')->name('role.relations.agenda.unit_participation.update');
