...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/dashboard/relations/agenda/{agendaEvent}/quick-subscribe', [RelationsAgendaEventsController::class, 'quickSubscribeBranchToPlan'])->middleware('role_or_permission:relations_officer|branch_relations_officer|super_admin|agenda.participation.update')->whereNumber('agendaEvent')->name('role.relations.agenda.quick_subscribe');
    ...
    Route::get('/dashboard/relations/monthly-activities', [ProgramsMonthlyActivitiesController::class, 'index'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|volunteer_coordinator|super_admin|monthly_activities.view')->middleware('branch.isolation')->name('role.relations.activities.index');
    Route::get('/dashboard/relations/monthly-activities/calendar', [ProgramsMonthlyActivitiesController::class, 'calendar'])->middleware('role_or_permission:relations_manager|relations_officer|branch_relations_officer|volunteer_coordinator|super_admin|monthly_activities.view')->middleware('branch.isolation')->name('role.relations.activities.calendar');
    ...
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|followup_officer|evaluation_officer|evaluation_followup_viewer|super_admin')->name('role.relations.activities.edit');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|super_admin')->name('role.relations.activities.show');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|followup_officer|evaluation_officer|super_admin')->name('role.relations.activities.update');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/submit', [ProgramsMonthlyActivitiesController::class, 'submit'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|super_admin')->name('role.relations.activities.submit');
    Route::patch('/dashboard/relations/monthly-activities/{monthlyActivity}/close', [ProgramsMonthlyActivitiesController::class, 'close'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|super_admin')->name('role.relations.activities.close');
