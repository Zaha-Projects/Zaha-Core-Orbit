...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/transport/requests', [TransportTransportRequestsController::class, 'index'])->middleware('role:super_admin')->name('role.transport.requests.index');
    Route::post('/dashboard/transport/requests', [TransportTransportRequestsController::class, 'store'])->middleware('role:super_admin')->name('role.transport.requests.store');
    Route::patch('/dashboard/transport/requests/{transportRequest}/process', [TransportTransportRequestsController::class, 'process'])->middleware('role:super_admin')->name('role.transport.requests.process');
    Route::patch('/dashboard/transport/requests/{transportRequest}/feedback', [TransportTransportRequestsController::class, 'feedback'])->middleware('role:super_admin')->name('role.transport.requests.feedback');
    ...
    Route::get('/dashboard/transport/movements', [TransportMovementsController::class, 'index'])->middleware('role:super_admin')->name('role.transport.movements.index');
    Route::get('/dashboard/transport/movements/create', [TransportMovementsController::class, 'create'])->middleware('role:super_admin')->name('role.transport.movements.create');
    Route::post('/dashboard/transport/movements', [TransportMovementsController::class, 'store'])->middleware('role:super_admin')->name('role.transport.movements.store');
    Route::get('/dashboard/transport/movements/{movementDay}', [TransportMovementsController::class, 'show'])->middleware('role:super_admin')->name('role.transport.movements.show');
    Route::get('/dashboard/transport/movements/{movementDay}/edit', [TransportMovementsController::class, 'edit'])->middleware('role:super_admin')->name('role.transport.movements.edit');
    Route::put('/dashboard/transport/movements/{movementDay}', [TransportMovementsController::class, 'update'])->middleware('role:super_admin')->name('role.transport.movements.update');
    Route::delete('/dashboard/transport/movements/{movementDay}', [TransportMovementsController::class, 'destroy'])->middleware('role:super_admin')->name('role.transport.movements.destroy');
