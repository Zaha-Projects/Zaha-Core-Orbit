...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/agenda/{agendaEvent}', [RelationsAgendaEventsController::class, 'show'])->middleware('branch.isolation')->whereNumber('agendaEvent')->name('role.relations.agenda.show');
    ...
    Route::patch('/dashboard/relations/monthly-activities/trash/{monthlyActivity}/restore', [ProgramsMonthlyActivitiesController::class, 'restore'])->middleware('role:super_admin|admin')->name('role.relations.activities.trash.restore');
    ...
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|supervisor|branch_coordinator|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|communication_head|transport_officer|movement_manager|administrative_unit_manager|super_admin')->name('role.relations.activities.show');
    ...
    Route::post('/dashboard/programs/monthly-activities/{monthlyActivity}/attachments', [ProgramsMonthlyActivityAttachmentsController::class, 'store'])->middleware('role:programs_manager|programs_officer|relations_manager|relations_officer|super_admin')->name('role.programs.attachments.store');
