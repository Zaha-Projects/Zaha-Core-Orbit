...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}/edit', [ProgramsMonthlyActivitiesController::class, 'edit'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|relations_officer|followup_officer|evaluation_officer|evaluation_followup_viewer|super_admin')->name('role.relations.activities.edit');
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|relations_officer|followup_officer|evaluation_officer|evaluation_followup_viewer|volunteer_coordinator|super_admin')->name('role.relations.activities.show');
    Route::put('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'update'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|relations_officer|followup_officer|evaluation_officer|super_admin')->name('role.relations.activities.update');
