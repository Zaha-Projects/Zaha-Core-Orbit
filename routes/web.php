...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/relations/monthly-activities/{monthlyActivity}', [ProgramsMonthlyActivitiesController::class, 'show'])->middleware('role:relations_manager|relations_officer|branch_relations_manager|branch_relations_officer|followup_officer|super_admin')->name('role.relations.activities.show');
