...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/dashboard/admin/workflows/{workflow}/steps/reorder', [SuperAdminWorkflowsController::class, 'reorderSteps'])->middleware('role_or_permission:super_admin|workflows.manage')->name('role.super_admin.workflow_steps.reorder');
